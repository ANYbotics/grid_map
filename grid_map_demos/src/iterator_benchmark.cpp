...
int main(int argc, char * argv[])
{
  ...
  cout << "Results for iteration over " << map.getSize()(0) << " x " << map.getSize()(1) << " (" <<
    map.getSize().prod() << ") grid cells." << endl;
  cout << "=========================================" << endl;
  ...
  t2 = clk::now();
  cout << "Duration grid map iterator (direct access to data layers): " << duration(t2 - t1) <<
    " ms" << endl;
