...
def generate_launch_description():
    ...
    declare_visualization_config_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            grid_map_demos_dir, 'config', 'iterators_demo.yaml'),
    ...
    iterators_demo_node = Node(
        package='grid_map_demos',
        executable='iterators_demo',
        name='grid_map_iterators_demo',
        output='screen'
    )
    ...
    ld.add_action(iterators_demo_node)
