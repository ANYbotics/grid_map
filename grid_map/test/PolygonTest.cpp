...
TEST(checkConvexHull, checkConvexHull)
{
  ...
  convexHull.convexHull(polygon1, polygon2);

  EXPECT_EQ(7, convexHull.nVertices());
  EXPECT_TRUE(convexHull.isInside(Vector2d(0.5, 0.5)));
  EXPECT_FALSE(convexHull.isInside(Vector2d(0.01, 1.49)));
